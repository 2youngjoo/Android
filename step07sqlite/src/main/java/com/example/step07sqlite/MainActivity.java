...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper=new DBHelper(this, "MyDB.sqlite",
                null, 1);
        // 할 일 목록을 담을 List 를 TodoDao 객체를 이용해서 얻어내기
        ...
        binding.addBtn.setOnClickListener(view->{
            ...
            //6. 모델의 내용이 바뀌었다고 어댑터에 알려서 ListView 가 업데이트 되도록 한다.
            adapter.notifyDataSetChanged();
            //7. ListView 의 가장 아래 쪽이 화면에 보일수 있도록 부드럽게 스크롤 시키기
        ...
        binding.listView.setOnItemLongClickListener((adapterView, view, index, id) -> {
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("네", (dialogInterface, i1) -> {
                        ...
                        // 모델의 내용이 바뀌 었다고 어댑터에 알려서 ListView 가 업데이트 되도록 한다.
                        adapter.notifyDataSetChanged();
                    })
