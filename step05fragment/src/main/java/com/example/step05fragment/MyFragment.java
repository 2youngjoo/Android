...
/*
        ...
        - 재활용 이라는 것은 여러개의 액티비티에서 사용 된다는 의미
...
public class MyFragment extends Fragment implements View.OnClickListener{
    ...
    // 해당 프레그먼트가 제어할 View 객체를 만들어서 리턴 해주는 메소드
    @Nullable
    @Override
    ...
    public void onClick(View view) {
        ...
        /*
             만일 프레그먼트에서 현재 자신을 제어하고 있는 액티비에 어떠한 데이터를
             전달 하고자 한다면 어떻게 해야 할까
         */
